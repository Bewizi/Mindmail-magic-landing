        ...
        <div className="space-y-8 max-w-xl">
          ...
          <ScrollReveal delay={700} direction="left">
            <p className="text-white/80 text-lg md:text-xl leading-relaxed">
              The science-backed system that transforms your conscious focus into your superpower, turning quantum possibilities into concrete realities in your life.
            </p>
          </ScrollReveal>
          
          <ScrollReveal delay={900} direction="left">
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 pt-4">
              <Link to="#book" className="cosmic-button text-center flex items-center justify-center">
          ...
          <ScrollReveal delay={1100} direction="left">
            <div className="flex items-center space-x-4 pt-4">
              <div className="flex -space-x-2">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="w-10 h-10 rounded-full bg-cosmic-500/20 border-2 border-cosmic-400/30 flex items-center justify-center text-xs font-medium text-white/90">
                    {i}
                  </div>
                ))}
              </div>
              <p className="text-white/60 text-sm">
                Join <span className="text-white font-medium">10,000+</span> people manifesting their reality through focused consciousness
              </p>
            </div>
          </ScrollReveal>
        </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -right-8 top-1/3 w-24 h-24">
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute inset-4 rounded-full bg-cosmic-400/30 animate-pulse" style={{animationDelay: '500ms'}}></div>
